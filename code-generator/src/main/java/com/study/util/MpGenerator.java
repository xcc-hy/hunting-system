...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("xcc");
        gc.setOutputDir("F:\\workspace\\java\\hunting_system\\common_define\\src\\main\\java");
...
//        strategy.setInclude(new String[] { "user" , "company"}); // 需要生成的表
...
//         strategy.setSuperEntityClass("java.io.Serializable");
        ...
        pc.setParent("com.study.hunting");
